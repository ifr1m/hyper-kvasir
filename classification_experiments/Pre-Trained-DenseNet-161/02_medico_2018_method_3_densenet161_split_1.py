...
parser.add_argument('-vai-i', '--vastAiId', help='This vast ai ID', type=int)
parser.add_argument('-vai-t', '--vastAiToken', help='This vast ai api token/key')
...
parser.add_argument("--val_fold", type=str, default="split_1", help="Select the validation fold",
